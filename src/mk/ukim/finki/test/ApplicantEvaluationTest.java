...
class EvaluatorBuilder {
    ...
    static Evaluator MoreExperience = applicant -> applicant.getEmploymentYears()>=10;
    static Evaluator MoreCreditScore = applicant -> applicant.getCreditScore()>=500;
    ...
    public static Evaluator build(Evaluator.TYPE type) throws InvalidEvaluation {
        ...
        switch (type){
            ...
            case NO_CRIMINAL_RECORD_AND_MORE_EXPERIENCE: return new ComplexEvaluator(NoCriminalRecordEvaluator,MoreExperience);
            case NO_CRIMINAL_RECORD_AND_MORE_CREDIT_SCORE: return new ComplexEvaluator(NoCriminalRecordEvaluator, MoreCreditScore);
            case MORE_EXPERIENCE_AND_MORE_CREDIT_SCORE: return new ComplexEvaluator(MoreExperience,MoreCreditScore);
